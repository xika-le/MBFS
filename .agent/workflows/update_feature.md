---
description: "Phase 3 — Update code React Native cho 1 feature khi Figma đã thay đổi. So sánh và chỉ sửa UI. Ví dụ: /update_feature 1.1"
---
...
- Nếu không tìm thấy → gợi ý `/scan_figma` trước
