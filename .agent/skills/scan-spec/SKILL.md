---
name: parse-specs
description: Phân tích ảnh/text mô tả UI → trả về structured spec object gồm danh sách functions với spec_description chi tiết. Dùng để hỗ trợ /scan_specs workflow.
argument-hint: <feature name hoặc context>
---

# Skill: Parse Specs (từ ảnh/text mô tả)
...
## Mục tiêu
Phân tích input thô (ảnh/text) và trả về **structured spec object** mô tả rõ ràng các functions + UI của feature, sẵn sàng để ghi vào `figma-to-code-plan.yaml`.
...
Trả về object JSON/YAML có thể ghi thẳng vào plan:
