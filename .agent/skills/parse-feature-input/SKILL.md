---
name: parse-feature-input
description: Phân rã chức năng hệ thống từ nhiều nguồn input (xlsx, doc, image, text). Output là cây phân rã feature có đánh số thứ tự theo format chuẩn. Ví dụ gọi: /parse-feature-input path/to/file.xlsx
disable-model-invocation: true
argument-hint: <đường dẫn file xlsx/doc/image HOẶC mô tả tính năng>
---
...
1. **Đánh số thứ tự tự động** (xem `.agent/skills/parse-feature-input/references/feature_list_template.md`)
...
- **Tham khảo template**: `.agent/skills/parse-feature-input/references/feature_list_template.md`
