...
5. Cập nhật `figma-to-code-plan.yaml` → đánh dấu Phase 0 hoàn tất
...
5. Cập nhật `figma-to-code-plan.yaml`:
   - Đánh dấu features đã gen
...
4. Cập nhật `figma-to-code-plan.yaml`:
   - Đánh dấu feature đã update
...
═══════════════════════════════════════════════════════
  Designer xong màn Đăng nhập, Đăng ký
═══════════════════════════════════════════════════════
...
═══════════════════════════════════════════════════════
  Designer xong toàn bộ module Quản lý chung
═══════════════════════════════════════════════════════
...
═══════════════════════════════════════════════════════
  Designer update lại màn Đăng nhập
═══════════════════════════════════════════════════════
...
═══════════════════════════════════════════════════════
  Designer xong module Xúc tiến đầu tư
═══════════════════════════════════════════════════════

Bạn:  /gen-module Xúc tiến đầu tư
  → AI gen toàn bộ features
  → Plan: Module 2 = done

═══════════════════════════════════════════════════════
  Có mockup ảnh cho feature chưa có trên Figma
═══════════════════════════════════════════════════════
...
- Mỗi lệnh gen/update → AI tự động cập nhật `figma-to-code-plan.yaml`
- Không cần cập nhật plan thủ công

### 3. Ký hiệu trạng thái trong Plan
```
scanned   Đã scan, chưa gen code
partial   Đã gen nhưng chưa đầy đủ
done      Đã gen hoàn chỉnh
```
